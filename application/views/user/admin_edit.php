<form id="the_form" class="form-horizontal form-bordered" novalidate="novalidate" action="<?php echo $this->config->item('link_admin_edit').'?id='.$id; ?>">
	...
	<input type="hidden" name="selfusername" id="selfusername" value="<?php echo $result->username; ?>">
	<div class="panel-body">
		<div class="form-group mt-lg">
			...
			<div class="col-sm-9">
				<select class="form-control" name="id_admin_tipe" id="id_admin_tipe">
					...
					<?php foreach ($admin_tipe_lists as $row) { ?>
						<option value="<?php echo $row->id_admin_tipe; ?>" <?php if ($result->id_admin_tipe == $row->id_admin_tipe) { echo 'selected="selected"'; } echo set_select('id_admin_tipe', $row->id_admin_tipe); ?>><?php echo $row->nama; ?></option>
					<?php } ?>
				</select>
		...
		<div class="form-group mt-lg">
			...
			<div class="col-sm-9">
				<input type="text" name="email" id="email" class="form-control" value="<?php echo set_value('email', $result->email); ?>" />
		...
		<div class="form-group mt-lg">
			...
			<div class="col-sm-9">
				<input type="text" name="username" id="username" class="form-control" value="<?php echo set_value('username', $result->username); ?>" />
