<form id="the_form" class="form-horizontal" novalidate="novalidate" action="<?php echo $this->config->item('link_simpanan_tipe_edit').'?id='.$id; ?>">
	<input type="hidden" name="selfnama" id="selfnama" value="<?php echo $result->nama; ?>">
	<div class="panel-body">
		<div class="form-group mt-lg">
			<label class="col-sm-3 control-label">Nama Tipe <span class="text-danger">*</span></label>
			<div class="col-sm-9">
