<form id="the_form" class="form-horizontal form-bordered" novalidate="novalidate" action="<?php echo $this->config->item('link_angsuran_create'); ?>">
	...
	<div class="panel-body">
		...
		<div class="form-group mt-lg">
			<label class="col-sm-4 control-label">No. Angsuran <span class="text-danger">*</span></label>
			<div class="col-sm-8">
				<input type="text" class="form-control" name="no_angsuran" id="no_angsuran" />
				<div class="text-danger" id="errorbox_no_angsuran"></div>
			</div>
		</div>
		<div class="form-group mt-lg">
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#the_form").validate({
            ...
            messages: {
                no_angsuran: {
                    required:"No. angsuran harus diisi."
                },
                tgl_angsuran: {
