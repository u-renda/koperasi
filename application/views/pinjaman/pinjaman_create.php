<form id="the_form" class="form-horizontal form-bordered" novalidate="novalidate" action="<?php echo $this->config->item('link_pinjaman_create'); ?>">
	...
	<div class="panel-body">
		...
		<div class="form-group mt-lg">
			...
			<div class="col-sm-8">
				<select class="form-control" name="id_pinjaman_tipe" id="id_pinjaman_tipe">
					...
					{
						echo '<option value="'.$row->id_pinjaman_tipe.'">'.$row->nama.'</option>';
					}
					?>
				</select>
		...
		<div class="form-group mt-lg">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" name="kali_angsuran" id="kali_angsuran" />
		...
		<div class="form-group mt-lg">
			...
			<div class="col-sm-8">
				<div class="input-group date date-picker">
					<input type="text" class="form-control" name="tgl_jatuh_tempo" id="tgl_jatuh_tempo" />
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
				</div>
